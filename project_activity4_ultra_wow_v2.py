# project_activity4_ultra_wow_v2.py
...
<head>
<meta charset="UTF-8">
<title>Project Activity 4 - Ultra Wow V2</title>
...
h1,h2 { color:#00FFAA; text-shadow:2px 2px 10px #0ff; margin-bottom:20px; }
...
.nav button:hover { background:#0cc; color:#fff; }
...
<h2>Ultra-Wow V2 Presentation</h2>
<p>Dynamic live dashboard + animations!</p>
</div>
...
<div class="card"><i class="fas fa-city icon"></i>City: Quezon City</div>
...
with open("project_activity4_ultra_wow_v2.html", "w") as f:
    f.write(html)

print("Ultra Wow V2 Presentation generated: project_activity4_ultra_wow_v2.html")
